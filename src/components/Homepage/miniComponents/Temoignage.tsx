  ...
  return (
    ...
    <div className="flex p-5   max-md:mx-5 max-md:gap-5 max-md:m-auto items-center     justify-between  my-20   ">
      ...
      <div className="flex gap-5 max-[1140px]:flex-wrap max-[1140px]:justify-center ">
        <DivTemoignage
          className="bg-jauneOr/5 size-80 max-md:size-72 flex flex-col  justify-around p-5  shadow-jauneOr/20 shadow-lg  font-lato"
          commentaire="“Une aide constructive et enrichissante tant pour découvrir les formations que pour rédiger les lettres de motivation. Un immense merci !
   Charles, élève de terminale”"
          image={false}
          nom="Charles"
          profession="Élève de terminale"
        />
        <DivTemoignage
          className="bg-jauneOr/5 size-80 max-md:size-72 flex flex-col justify-around p-5 shadow-jauneOr/20 shadow-lg  font-lato"
          commentaire="“Superbe expérience ! J’ai réalisé plusieurs entretiens
   et tests pour Parcoursup qui m’ont bien aidé pour l’orientation tant pour les spécialités 
   que pour les écoles.”"
          image={false}
          nom="Léa"
          profession="classe de terminale"
        />
        <DivTemoignage
          className="bg-jauneOr/5 size-80 max-md:size-72 flex flex-col justify-around p-5  shadow-jauneOr/20 shadow-lg  font-lato"
          commentaire="Super conseillère qui a me suit depuis le début de mon lycée.
   Elle a su me donner les bons conseils ainsi que les bonnes préparations aux concours. 
   Je recommande vraiment son professionnalisme ainsi que sa gentillesse !"
          image={false}
          nom="Jules"
